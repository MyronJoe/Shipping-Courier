    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content">
                ...
                <form action="{{url('update_features', $datas->id)}}" method="POST" novalidate enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input col-sm-12">
                            <div>
                                ...
                                <input type="text" class="form-control" name="feature_title" id="title" value="{{ $datas->feature_title }}">
                                @error('feature_title')
                        ...
                        <div class="input col-sm-12">
                            <div>
                                ...
                                <textarea name="feature_sub" id="sub_title" cols="10" rows="5" class="form-control">
                                {{ $datas->feature_sub }}
                                </textarea>
                                @error('feature_sub')
                                <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="upload-sec">
                        ...
                        <label for="image" class="my-2 label">
                            ...
                            <img src="../assets/img/{{$datas->feature_image}}" alt="">
                    ...
                    <input type="submit" name="add_shipment" value="Update Features" class="btn btn-primary my-3 ">
                ...
                <div class="container-fluid p-0 mt-2">
                    ...
                    <div class="mb-1">
                        ...
                        <h1 class="h3 d-inline align-middle"><strong>Features</strong></h1>

                        <a href="{{url('add_feature')}}" class="btn btn-primary" style="float: right;">Add Feature</a>
                    </div>
